...
<div class="main">
  <div class="main-content">
    <div class="content-fluid">
      ...
      <h1 class="mt-3">Form Register Donatur</h1>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <label for="password">Password</label>
             <input type="text" class="form-control  @error ('password') is-invalid @enderror" id="no_rek" placeholder="" name="password" value="{{ old('password') }}">
